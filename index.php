    ...
    <header class="w3-container w3-theme w3-padding" id="myHeader">
      <div class="w3-center">
        ...
        <div class="w3-padding-32">
          <button class="w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey" onclick="location.href='dash/login.php'" style="font-weight:900;">LOGIN</button> <br>
